...
Some assignment come with a *testing suite* that can help you evaluate if your implementation is correct. As of 2020, these automatic testing are not complete and you cannot rely on them yet. However, some of thos tests are already implement, so please free to use them if they exist.
...
Please make sure first that something in this document doesn't already address your issue! If you still have problems, simply open an issue on the starter code repository for this assignment [here](https://github.com/NUCS31/hw1-getting-started/issues). Someone from the teaching staff will get back to you through there!
